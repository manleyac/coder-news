### This is an example blog post. See original [here](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/ch1.md)
...
![Fig. 1: Compiled vs. Interpreted Code](https://i.imgur.com/oJrgAJt_d.webp?maxwidth=760&fidelity=grand)
